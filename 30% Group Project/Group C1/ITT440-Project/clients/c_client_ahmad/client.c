...
#define SERVER_NAME "c_server_ahmad"
...
int main() {
    printf("C Client (Ahmad) starting...\n");
                ...
                if (connect(sock, (struct sockaddr *)&server_addr, sizeof(server_addr)) >= 0) {
                    ...
                    if (send(sock, buffer, strlen(buffer), 0) >= 0) {
                        ...
                        if (bytes_received > 0) {
                            ...
                            char *points_str = strstr(buffer, "Ahmad Points:");
                            if (points_str) {
                                points_str += strlen("Ahmad Points:");
