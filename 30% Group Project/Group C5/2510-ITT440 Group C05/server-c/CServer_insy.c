...
//To update points every 30 seconds
void *update_points(void *arg) {
    while (1) {
        ...
        //update points in table database
        char query[256];
...
//db info to connect phpmyadmin
    ...
    printf("CServer_Insyi run on port %d\n", SERVER_PORT);
