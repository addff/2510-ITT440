...
SERVER_HOST = os.getenv('SERVER_HOST', 'server-python2')
SERVER_PORT = int(os.getenv('SERVER_PORT', 4002))

def request_data():
    print(f"AmniPY_Client starting... connecting to {SERVER_HOST}:{SERVER_PORT}")
