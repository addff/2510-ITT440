...
## 📄 About Spike Test
<div style="text-align: justify;">
a test that suddenly increases or decreases the load on the system or software application. The load is generated by a huge number of users, and the behavior of the system is observed. The spike test aims to determine whether a system will fail or survive in case of dramatic change in load.
</div>
...
<p align="center">
<img width="450" height="450" alt="Image" src="https://github.com/user-attachments/assets/d4ba7225-d3e3-4d3e-aaf0-fc51e7b970fa" />
</p>

2. Install Drupal demo's website on a local machine.
<p align="center">
<img width="1903" height="1139" alt="Image" src="https://github.com/user-attachments/assets/cb2f82d7-4ac1-4b85-b343-de0ba86326ab" />
</p>

3. Set up Drupal's demo server using phpMyAdmin.
<p align="center">
<img width="1689" height="907" alt="Image" src="https://github.com/user-attachments/assets/6e247a41-29b5-4837-b25b-d86d7a703f73" />
</p>
...
<p align="center">
<img width="1000" height="1000" alt="Image" src="https://github.com/user-attachments/assets/89d3ca6e-8a60-484e-abc8-22684ff904ac" />
</p>

3. **Chili Sauce Recipe** - `GET /websitegua/en/recipes/fiery-chili-sauce`
<p align="center">
<img width="1000" height="1000" alt="Image" src="https://github.com/user-attachments/assets/ef0d8e27-2aa1-4b93-9543-041f8715031b" />
</p>

5. **Soup Recipe** - `GET /websitegua/en/recipes/watercress-soup`
<p align="center">
<img width="1000" height="1000" alt="Image" src="https://github.com/user-attachments/assets/4ea88705-9560-4800-9541-253b24a969c9" />
</p>

7. **Search Function** - `GET /websitegua/en/search/node?keys=pasta`
<p align="center">
<img width="1000" height="1000" alt="Image" src="https://github.com/user-attachments/assets/70f88046-81d8-4087-ace6-c8c0a5e15a30" />
</p>
...
### Over Time Charts
<p align="center">
<img width="1217" height="639" alt="image" src="https://github.com/user-attachments/assets/2360f8be-16ba-42ee-89c7-8bf3f7c4e81e" />
</p>

<p align="center">
<img width="1216" height="642" alt="image" src="https://github.com/user-attachments/assets/927d6028-80ea-44fe-8d41-e20758801e8b" />
</p>

<p align="center">
<img width="1216" height="619" alt="image" src="https://github.com/user-attachments/assets/ad5ea76e-2317-4715-8400-e07fef68c154" />
</p>

### Throughput Charts
<p align="center">
<img width="1214" height="611" alt="image" src="https://github.com/user-attachments/assets/f8e210bd-5406-409a-bae0-b715588da4cf" />
</p>

<p align="center">
<img width="1214" height="612" alt="image" src="https://github.com/user-attachments/assets/c669a94c-e9a0-411b-90f0-5fc9f6fe9826" />
</p>

<p align="center">
<img width="1216" height="616" alt="image" src="https://github.com/user-attachments/assets/cf7eb490-473b-4721-8e17-73a1089f64b1" />
</p>

### Response Time Charts
<p align="center">
<img width="1226" height="636" alt="image" src="https://github.com/user-attachments/assets/91b5360e-a88b-49f7-9c71-286e7524f2d1" />
</p>
---
...
- **Critical Finding**: Even at baseline with minimal load (100 threads), response times of 9 seconds indicate serious performance issues. The 13.5-second peak response time during the 200-thread spike is unacceptable for any web application. **Soup** line is in static assets or cached responses, which maintain acceptable performance.
...
- **Dominant Transaction** (Pork Ribs): Peaks at ~8.5 transactions/sec
  - Likely represents one of the recipe pages (most frequently accessed)
- **Other Transactions** (Soup, Search, Sauce): Remain relatively flat at ~2-3 transactions/sec
...
- **Primary Request** (Pork Ribs - dominant): Shows severe degradation
...
- **Interpretation**: The main page/endpoint (Pork Ribs) is the clear performance bottleneck, while static resources or simpler endpoints maintain reasonable response times. This suggests:
...
## 📹Spike Testing Demonstration
https://www.youtube.com/watch?v=twIkTALSjtQ
